...
{
    public sealed record RoleUnassignedDomainEvent : DomainEvent
    {
        public static RoleUnassignedDomainEvent Create(Guid identityId, string roleName)
            => new(identityId, roleName);

        public Guid IdentityId { get; }
        public string RoleName { get; } = null!;
        private RoleUnassignedDomainEvent(Guid identityId, string roleName)
        ...
        private RoleUnassignedDomainEvent()
        { }
    }
}